 ...
 *   1. Translation pairs   — same verse across LDS ↔ modern-English translations (paraphrase)
...
console.log(`\n1. Translation pairs (LDS↔modern English): ${translationCount.toLocaleString()}`);
...
console.log(`════════════════════════════════════════`);
console.log(`\nBreakdown:`);
console.log(`  Translation (LDS↔modern English): ${translationCount.toLocaleString()}`);
