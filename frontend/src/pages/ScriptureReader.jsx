        ...
        <div className="rd-home">
          ...
          <div className="rd-search-wrap">
            ...
            <input
              ...
              spellCheck="false"
            />
            {query && <button className="rd-search-clear" onClick={() => { setQuery(''); setSearchResults([]); }}>✕</button>}
          </div>
        ...
        <div className="rd-overlay" onClick={() => setLpMenu(null)}>
          <div className="rd-lp-menu" onClick={e => e.stopPropagation()}>
            ...
            <div className="rd-lp-actions">
              ...
              <button className="rd-lp-act" onClick={() => { try { navigator.clipboard.writeText(`${lpMenu.verse.scripture_text} — ${lpMenu.verse.book_title} ${lpMenu.verse.chapter_number}:${lpMenu.verse.verse_number}`); } catch { /* ignore */ } setLpMenu(null); }}>📋 Copy verse</button>
